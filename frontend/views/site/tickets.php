...
<div class="card border-0 pb-0">
    <div class="card-body">
        <div id="DZ_W_Todo3" class="widget-media ps ps--active-y">
            <?php if (!empty($leads)): ?>
                <ul class="timeline">
                    ...
                    <div class="ps__rail-y" style="top: 0px; height: 370px; right: 0px;">
                        <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 177px;"></div>
                    </div>
                </ul>
                    ...
                    <div class="box box-solid">
                        <div class="box-body">
                            <div class="empty-tickets">
                                <h4>You don't have any tickets yet </h4>
                            </div>
