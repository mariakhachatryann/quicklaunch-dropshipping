...
const AdminSettings = {
  ...
  ManageDarkThemeLayout() {
    ...
    switch (settings.Theme) {
      case "light":
        setTheme("light", ["light-logo", "brand-title-white"], ["moon", "brand-title-silver"], ["sun"]);
        break;
      case "dark":
        setTheme("dark", ["dark-logo", "brand-title-silver"], ["sun", "brand-title-white"], ["moon"]);
        break;
      default:
        break;
    }
  ...
  function handleTheme() {
    ...
    document.querySelectorAll(".dark-layout").forEach((element) => {
      element.addEventListener("click", () => {
        setThemeAttributes("dark", "brand-title-silver", "brand-title-white", "moon", "sun");
      })
    });

    document.querySelectorAll(".light-layout").forEach((element) => {
      element.addEventListener("click", () => {
        setThemeAttributes("light", "brand-title-white", "brand-title-silver", "sun", "moon")
      })
    });
